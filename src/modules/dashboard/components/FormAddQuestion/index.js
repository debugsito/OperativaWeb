...
export default function Index({ handleChange, values, index, length, deletedValues }) {
        ...
        <>
            ...
            <Grid item xs={3}>
                ...
                >
                    ...
                    <MenuItem value="answer-multiple">Respuesta multiple</MenuItem>
            ...
            </Grid>
            {
                length > 1 &&
                <Grid item xs={1}>
                    <IconButton aria-label="delete" color="secondary" onClick={() => deletedValues(index)}>
                        <DeleteIcon />
                    </IconButton>
                </Grid>
            }
