...
import { Grid, MenuItem, RadioGroup, FormControlLabel, FormControl, FormHelperText, Paper, makeStyles } from "@material-ui/core";

import { updatePublication, savePublication } from "../../../../store/actions/dashboard/dashboard.middleware";
import { Button, Checkbox, Select, Modal, Radio, RichText, TextInput, Typography, ToolTip } from "../../../shared/components";
        ...
        <div>
            <Paper elevation={0} className={classes.paper}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <Typography variant="h6" color="secondary">Datos del aviso</Typography>
                    </Grid>
                    <Grid item xs={12}>
            ...
            <Grid container spacing={2} justifyContent="flex-end">
                ...
                <Grid item>
                    <Button variant="contained" size="large" onClick={() => setOpenModal(true)}>CONTINUAR</Button> {/*  disabled={disabledButtonState} */}
                </Grid>
            </Grid>
