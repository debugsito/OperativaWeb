        ...
        <div className={classes.root}>
            ...
            <div className={classes.containerText}>
                <p className={classes.text}>
                    <strong>INNOVATE PERU</strong> y el <strong>MINISTERIO DE LA PRODUCCIÓN</strong> denominan ganador a <strong>OPERATIVA</strong>, como la <strong>1era Plataforma Tecnológica con IA que automatiza los procesos masivos de reclutamiento operario</strong>, segmentada por sectores productivos y que predice el tiempo de permanencia del trabajador en la empresa.
                </p>
                <p className={classes.text}>
